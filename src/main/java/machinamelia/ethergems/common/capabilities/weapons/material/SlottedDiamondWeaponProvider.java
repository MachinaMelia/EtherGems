...
public class SlottedDiamondWeaponProvider implements ICapabilitySerializable<INBT> {
    @CapabilityInject(ISlottedWeapon.class)
    public static final Capability<ISlottedWeapon> WEAPON_CAPABILITY = null;

    private final LazyOptional<ISlottedWeapon> instance = LazyOptional.of(SlottedDiamondWeaponInstance::new);
