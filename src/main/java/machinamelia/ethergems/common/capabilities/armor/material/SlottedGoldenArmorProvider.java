...
public class SlottedGoldenArmorProvider implements ICapabilitySerializable<INBT> {
    @CapabilityInject(ISlottedArmor.class)
    public static final Capability<ISlottedArmor> ARMOR_CAPABILITY = null;

    private final LazyOptional<ISlottedArmor> instance = LazyOptional.of(SlottedGoldenArmorInstance::new);
