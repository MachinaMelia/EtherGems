...
public class CylinderStorage implements Capability.IStorage<ICylinder> {
    @Override
    public INBT writeNBT(Capability<ICylinder> capability, ICylinder instance, Direction side)
    {
    ...
    @Override
    public void readNBT(Capability<ICylinder> capability, ICylinder instance, Direction side, INBT nbt)
    {
        CompoundNBT compoundNBT = (CompoundNBT) nbt;
        instance.setAttribute(compoundNBT.getString("Attribute"));
        instance.setStrength(compoundNBT.getInt("Strength"));
