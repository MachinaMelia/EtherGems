...
public class PureFireDeposit extends PureEtherDeposit {
    public PureFireDeposit() {
        super();
    }
    @Override
    public Item getCrystal() {
        return ItemInit.PURE_FIRE_CRYSTAL.get();
    }
    @Override
    protected IParticleData getEtherParticle() {
        return ParticleInit.FIRE_ETHER_PARTICLE.get();
    }
}
