...
public class PureWaterDeposit extends PureEtherDeposit {
    public PureWaterDeposit() {
        super();
    }
    @Override
    public Item getCrystal() {
        return ItemInit.PURE_WATER_CRYSTAL.get();
    }
    @Override
    protected IParticleData getEtherParticle() {
        return ParticleInit.WATER_ETHER_PARTICLE.get();
    }
}
