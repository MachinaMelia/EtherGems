...
public class PureElectricDeposit extends PureEtherDeposit {
    public PureElectricDeposit() {
        super();
    }
    @Override
    public Item getCrystal() {
        return ItemInit.PURE_ELECTRIC_CRYSTAL.get();
    }
    @Override
    protected IParticleData getEtherParticle() {
        return ParticleInit.ELECTRIC_ETHER_PARTICLE.get();
    }
}
