...
public class ItemInit {
    ...
    public static final RegistryObject<SlottedDyeableArmor> SLOTTED_LEATHER_HELMET = ITEMS.register("slotted_leather_helmet", () -> new SlottedDyeableArmor(ArmorMaterial.LEATHER, EquipmentSlotType.HEAD, (new Item.Properties()).group(ItemGroup.COMBAT)));
    public static final RegistryObject<SlottedDyeableArmor> SLOTTED_LEATHER_CHESTPLATE = ITEMS.register("slotted_leather_chestplate", () -> new SlottedDyeableArmor(ArmorMaterial.LEATHER, EquipmentSlotType.CHEST, (new Item.Properties()).group(ItemGroup.COMBAT)));
    public static final RegistryObject<SlottedDyeableArmor> SLOTTED_LEATHER_LEGGINGS = ITEMS.register("slotted_leather_leggings", () -> new SlottedDyeableArmor(ArmorMaterial.LEATHER, EquipmentSlotType.LEGS, (new Item.Properties()).group(ItemGroup.COMBAT)));
    public static final RegistryObject<SlottedDyeableArmor> SLOTTED_LEATHER_BOOTS = ITEMS.register("slotted_leather_boots", () -> new SlottedDyeableArmor(ArmorMaterial.LEATHER, EquipmentSlotType.FEET, (new Item.Properties()).group(ItemGroup.COMBAT)));
    public static final RegistryObject<SlottedArmor> SLOTTED_IRON_HELMET = ITEMS.register("slotted_iron_helmet", () -> new SlottedArmor(ArmorMaterial.IRON, EquipmentSlotType.HEAD, (new Item.Properties()).group(ItemGroup.COMBAT)));
    public static final RegistryObject<SlottedArmor> SLOTTED_IRON_CHESTPLATE = ITEMS.register("slotted_iron_chestplate", () -> new SlottedArmor(ArmorMaterial.IRON, EquipmentSlotType.CHEST, (new Item.Properties()).group(ItemGroup.COMBAT)));
    public static final RegistryObject<SlottedArmor> SLOTTED_IRON_LEGGINGS = ITEMS.register("slotted_iron_leggings", () -> new SlottedArmor(ArmorMaterial.IRON, EquipmentSlotType.LEGS, (new Item.Properties()).group(ItemGroup.COMBAT)));
    public static final RegistryObject<SlottedArmor> SLOTTED_IRON_BOOTS = ITEMS.register("slotted_iron_boots", () -> new SlottedArmor(ArmorMaterial.IRON, EquipmentSlotType.FEET, (new Item.Properties()).group(ItemGroup.COMBAT)));
    public static final RegistryObject<SlottedArmor> SLOTTED_GOLDEN_HELMET = ITEMS.register("slotted_golden_helmet", () -> new SlottedArmor(ArmorMaterial.GOLD, EquipmentSlotType.HEAD, (new Item.Properties()).group(ItemGroup.COMBAT)));
    public static final RegistryObject<SlottedArmor> SLOTTED_GOLDEN_CHESTPLATE = ITEMS.register("slotted_golden_chestplate", () -> new SlottedArmor(ArmorMaterial.GOLD, EquipmentSlotType.CHEST, (new Item.Properties()).group(ItemGroup.COMBAT)));
    public static final RegistryObject<SlottedArmor> SLOTTED_GOLDEN_LEGGINGS = ITEMS.register("slotted_golden_leggings", () -> new SlottedArmor(ArmorMaterial.GOLD, EquipmentSlotType.LEGS, (new Item.Properties()).group(ItemGroup.COMBAT)));
    public static final RegistryObject<SlottedArmor> SLOTTED_GOLDEN_BOOTS = ITEMS.register("slotted_golden_boots", () -> new SlottedArmor(ArmorMaterial.GOLD, EquipmentSlotType.FEET, (new Item.Properties()).group(ItemGroup.COMBAT)));
    public static final RegistryObject<SlottedArmor> SLOTTED_DIAMOND_HELMET = ITEMS.register("slotted_diamond_helmet", () -> new SlottedArmor(ArmorMaterial.DIAMOND, EquipmentSlotType.HEAD, (new Item.Properties()).group(ItemGroup.COMBAT)));
    public static final RegistryObject<SlottedArmor> SLOTTED_DIAMOND_CHESTPLATE = ITEMS.register("slotted_diamond_chestplate", () -> new SlottedArmor(ArmorMaterial.DIAMOND, EquipmentSlotType.CHEST, (new Item.Properties()).group(ItemGroup.COMBAT)));
    public static final RegistryObject<SlottedArmor> SLOTTED_DIAMOND_LEGGINGS = ITEMS.register("slotted_diamond_leggings", () -> new SlottedArmor(ArmorMaterial.DIAMOND, EquipmentSlotType.LEGS, (new Item.Properties()).group(ItemGroup.COMBAT)));
    public static final RegistryObject<SlottedArmor> SLOTTED_DIAMOND_BOOTS = ITEMS.register("slotted_diamond_boots", () -> new SlottedArmor(ArmorMaterial.DIAMOND, EquipmentSlotType.FEET, (new Item.Properties()).group(ItemGroup.COMBAT)));
    public static final RegistryObject<SlottedSword> SLOTTED_WOODEN_SWORD = ITEMS.register("slotted_wooden_sword", () -> new SlottedSword(ItemTier.WOOD, 3, -2.4F, (new Item.Properties()).group(ItemGroup.COMBAT)));
    public static final RegistryObject<SlottedSword> SLOTTED_STONE_SWORD = ITEMS.register("slotted_stone_sword", () -> new SlottedSword(ItemTier.STONE, 3, -2.4F, (new Item.Properties()).group(ItemGroup.COMBAT)));
    public static final RegistryObject<SlottedSword> SLOTTED_IRON_SWORD = ITEMS.register("slotted_iron_sword", () -> new SlottedSword(ItemTier.IRON, 3, -2.4F, (new Item.Properties()).group(ItemGroup.COMBAT)));
    public static final RegistryObject<SlottedSword> SLOTTED_GOLDEN_SWORD = ITEMS.register("slotted_golden_sword", () -> new SlottedSword(ItemTier.GOLD, 3, -2.4F, (new Item.Properties()).group(ItemGroup.COMBAT)));
    public static final RegistryObject<SlottedSword> SLOTTED_DIAMOND_SWORD = ITEMS.register("slotted_diamond_sword", () -> new SlottedSword(ItemTier.DIAMOND, 3, -2.4F, (new Item.Properties()).group(ItemGroup.COMBAT)));
    public static final RegistryObject<SlottedAxe> SLOTTED_WOODEN_AXE = ITEMS.register("slotted_wooden_axe", () -> new SlottedAxe(ItemTier.WOOD, 6.0F, -3.2F, (new Item.Properties()).group(ItemGroup.TOOLS)));
    public static final RegistryObject<SlottedAxe> SLOTTED_STONE_AXE = ITEMS.register("slotted_stone_axe", () -> new SlottedAxe(ItemTier.STONE, 7.0F, -3.2F, (new Item.Properties()).group(ItemGroup.TOOLS)));
    public static final RegistryObject<SlottedAxe> SLOTTED_IRON_AXE = ITEMS.register("slotted_iron_axe", () -> new SlottedAxe(ItemTier.IRON, 6.0F, -3.1F, (new Item.Properties()).group(ItemGroup.TOOLS)));
    public static final RegistryObject<SlottedAxe> SLOTTED_GOLDEN_AXE = ITEMS.register("slotted_golden_axe", () -> new SlottedAxe(ItemTier.GOLD, 6.0F, -3.0F, (new Item.Properties()).group(ItemGroup.TOOLS)));
    public static final RegistryObject<SlottedAxe> SLOTTED_DIAMOND_AXE = ITEMS.register("slotted_diamond_axe", () -> new SlottedAxe(ItemTier.DIAMOND, 5.0F, -3.0F, (new Item.Properties()).group(ItemGroup.TOOLS)));
