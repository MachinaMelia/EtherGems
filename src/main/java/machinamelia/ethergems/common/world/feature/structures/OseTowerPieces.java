...
import machinamelia.ethergems.common.init.FeatureInit;
...
public class OseTowerPieces  {
    ...
    public static class Piece extends TemplateStructurePiece {
        ...
        public Piece(TemplateManager templateManagerIn, ResourceLocation resourceLocationIn, BlockPos pos,
                     Rotation rotationIn) {
            super(FeatureInit.OSE_TOWER_PIECE, 0);
        ...
        public Piece(TemplateManager templateManagerIn, CompoundNBT tagCompound) {
            super(FeatureInit.OSE_TOWER_PIECE, tagCompound);
        ...
        protected void handleDataMarker(String function, BlockPos pos, IWorld worldIn, Random rand,
            ...
            if ("chest".equals(function)) {
                ...
                worldIn.setBlockState(pos, Blocks.TRAPPED_CHEST.getDefaultState().rotate(worldIn, pos, Rotation.CLOCKWISE_90), 2);
